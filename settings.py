...
BOSS_ARM_UP_URL = './Assets/enemies/boss/arm_up.png'
BOSS_ARM_DOWN_URL = './Assets/enemies/boss/arm_down.png'
...
WEAPONS = {
    'toxic': {'key':0,'damage': 0.1, 'speed': 20, 'type': 'Shot1', 'fire_rate': 0.6, 'capacity': 17, 'pic': './Assets/particles/Shot1/shot1_exp2.png'},
    ...
    'speed': {'key':5,'damage': 1, 'speed': 30, 'type': 'Shot6', 'fire_rate': 0.4, 'capacity': 17, 'pic': './Assets/particles/Shot6/shot6_exp1.png'},
    'gravity': {'key':6,'damage': 1, 'speed': 15, 'type': 'Shot7', 'fire_rate': 0.7, 'capacity': 13, 'pic': './Assets/particles/Shot7/07.png'},
    'boss_shot': {'key': 7, 'damage': 5, 'speed': 15, 'type': 'boss_shot', 'fire_rate': 5, 'capacity': 15, 'pic': './Assets/bullets/boss_shot/boss_shot1.png'}
}